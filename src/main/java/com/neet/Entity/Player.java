...
public class Player extends MapObject {
	...
	public Player(TileMap tm) {
		...
		try {
			...
			BufferedImage spritesheet = ImageIO.read(
				getClass().getResourceAsStream(
					"/images/sprites/Player/PlayerSprites.gif"
				)
			);
		...
		JukeBox.load("/audio/sfx/playerjump.mp3", "playerjump");
		JukeBox.load("/audio/sfx/playerlands.mp3", "playerlands");
		JukeBox.load("/audio/sfx/playerattack.mp3", "playerattack");
		JukeBox.load("/audio/sfx/playerhit.mp3", "playerhit");
		JukeBox.load("/audio/sfx/playercharge.mp3", "playercharge");

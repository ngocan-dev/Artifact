...
public class Level1CState extends GameState {
	...
	public void init() {
		...
		// backgrounds
		temple = new Background("/images/backgrounds/temple.gif", 0.5, 0);
		...
		// music
		JukeBox.load("/audio/music/level1boss.mp3", "level1boss");
		JukeBox.load("/audio/music/fanfare.mp3", "fanfare");

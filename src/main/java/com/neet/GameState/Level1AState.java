...
public class Level1AState extends GameState {
	...
	public void init() {
		...
		// backgrounds
		sky = new Background("/images/backgrounds/sky.gif", 0);
		clouds = new Background("/images/backgrounds/clouds.gif", 0.1);
		mountains = new Background("/images/backgrounds/mountains.gif", 0.2);
		
		// tilemap
		tileMap = new TileMap(30);
		tileMap.loadTiles("/images/tilesets/ruinstileset.gif");
		...
		try {
			hageonText = ImageIO.read(
				getClass().getResourceAsStream("/ui/HageonTemple.gif")
			);
		...
		// sfx
		JukeBox.load("/audio/sfx/teleport.mp3", "teleport");
		JukeBox.load("/audio/sfx/explode.mp3", "explode");
		JukeBox.load("/audio/sfx/enemyhit.mp3", "enemyhit");
